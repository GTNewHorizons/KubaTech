...
public class EIGIC2Mode extends EIGMode {
    ...
    @Override
    public int getUIIndex() { return 1; }
    @Override
    public String getName() { return "IC2";  }
    @Override
    public int getMinVoltageTier() { return GT_MetaTileEntity_ExtremeIndustrialGreenhouse.EIG_BALANCE_IC2_MODE_MIN_TIER; }
    @Override
    public int getMinGlassTier() { return GT_MetaTileEntity_ExtremeIndustrialGreenhouse.EIG_BALANCE_IC2_MODE_MIN_TIER; }
    @Override
    public int getStartingSlotCount() { return 4; }
    @Override
    public int getSlotPerTierMultiplier() { return 4; }
    @Override
    public int getSeedCapacityPerSlot() { return 1; }
    @Override
    public int getWeedEXMultiplier() { return 5; }
    @Override
    public int getMaxFertilizerUsagePerSeed() { return 40; }
    @Override
    public double getFertilizerBoost() { return 0.1d; }
    ...
    public GT_Multiblock_Tooltip_Builder addTooltipInfo(GT_Multiblock_Tooltip_Builder builder) {
        ...
        return builder
            ...
            .addInfo("Every tier past " + minVoltageTier + ", slots are multiplied by " + this.getSlotPerTierMultiplier())
